...
public class LC1_TwoSum {
	...
	public static int[] twoSumIndicies_Approach3(int[] nums, int target) {
		...
		// Add elements to map, if complement does not exist in the map, untill it
		// exists.
	...
	// Time complexity - O(n)
	// Space Complexity - O(n) - space is not used, unless the matching complement
	// is found in the last iteration
